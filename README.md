...
Right now, I'm focusing on learning React. I'm diving deep into core concepts like components, hooks, and routing with React Router. My goal is to create responsive and optimized user interfaces for a better user experience.
